...
model = Backbone.Model.extend({
	...
	initialize: function(){
        ...
        if(this.get("firstname") == null && this.get("lastname") == null){
            ...
            this.set({ name : this.get("lastname") });        	
        }
        else if (this.get("lastname") == null ){
            this.set({ name : this.get("firstname") });
        }

        else this.set({ name : this.get("firstname")+" "+this.get("lastname") });
	},
	...
	set_gravatar: function(){
		...
		this.set({
			gravatar : 'http://www.gravatar.com/avatar/' + MD5(this.email)
		});
	},
